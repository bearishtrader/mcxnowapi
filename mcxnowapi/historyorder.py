# -*- coding: utf-8 -*-
#
# Module HistoryOrder for mcxnowapi - Python 27
# 
...
class HistoryOrder():
    ...
    # One Order 
    #
    def __init__(self, time, type, price,  amt, amtBTC):
        self.Time=time
...
class HistoryOrdersCurrency():
    #
    # History of all orders in a currency
    #
    def __init__(self):
        self.Id=[]
        
    def AddOrder(self, time, type, price, amt,  amtBTC):
        self.Id.append(HistoryOrder(time, type, price, amt, amtBTC))
        
    def Clear(self):
        del self.Id[:]

    
class HistoryAllOrders():
    #
    # History of All orders of all the currency
    #
    def __init__(self):
        self.Orders={}
        self.ClearAllOrders()
        
    def AddOrder(self, cur, time, type, price, amt, amtBTC):
        if self.Orders[cur]==None:
            self.Orders[cur]=HistoryOrdersCurrency()
        self.Orders[cur].AddOrder(time, type, price, amt, amtBTC)
