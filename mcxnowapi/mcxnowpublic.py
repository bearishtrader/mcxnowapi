# -*- coding: utf-8 -*-
#
# Module McxNowPublic for mcxnowapi - Python 27
# 
...
class McxNowPublic():
    #
    # Public information : orders, history...
    #    
    def __init__(self):
        self.BookBuy=PublicAllOrders()
        self.BookSell=PublicAllOrders()
        self.History=HistoryAllOrders()
        self.UsersLogged=0
        self.Info=McxNowTradedCurrency()
        self.Chat=Chat()
